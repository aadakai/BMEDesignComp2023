...
#Copy address from Demo.py
arm = meArm.meArm()
arm.begin(block = 0, address = 0x6f) # block address of motor controller
...
while (not stop):
    ...
    #Defense code, moving meArm with camera
        arm.goDirectlyTo(x,y,110)
